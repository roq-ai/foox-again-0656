  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox again, your ultimate marketplace where freelancers meet companies offering jobs. Transforming the way you hire and work!"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox again, your ultimate marketplace where freelancers meet companies offering jobs. Transforming the way you hire and work!`}
            </Text>
            <Box
